...
namespace OldTruck {
    public class OldTruck : Mod {
        ...
        public static Settings HideMudFlaps;
        ...
        public override void ModSettings() {
            ...
            HideMudFlaps = new Settings("hideFlaps", "Hide mud flaps", false);
            ...
            Settings.AddCheckBox(this, HideMudFlaps);
        ...
        public static void PrintF(string s) {
            ModConsole.Print(string.Format("[OldTruck] {0}",s));
        }
